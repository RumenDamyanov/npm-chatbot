...
describe('Provider Simple Tests', () => {
  ...
  describe('Provider Factory', () => {
    ...
    it('should throw error when provider is missing', async () => {
      ...
      expect(() => ProviderFactory.createProvider(config as any)).toThrow('AI provider type is required');
    });
  ...
  describe('Provider Configuration Validation', () => {
    ...
    it('should handle multiple providers with different configs', async () => {
      ...
      expect(openaiProvider.capabilities.maxInputTokens).not.toBe(anthropicProvider.capabilities.maxInputTokens);
    });
  });
